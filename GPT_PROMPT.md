...
- Never invent or renumber steps; use the step numbers and titles exactly as defined in `GPT_KNOWLEDGE.md` (steps start at 1).
- Do not introduce extra sub-steps or actions (including "open/create a new file") unless they appear verbatim in the step guidance from `GPT_KNOWLEDGE.md`.
