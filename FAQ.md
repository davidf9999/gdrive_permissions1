...
See the detailed guidance in the [Sheet Editor User Guide](docs/SHEET_EDITOR_USER_GUIDE.md#how-do-i-share-a-new-document-with-everyone-who-already-has-access-to-a-managed-folder) for the recommended approach (copy/move into the managed folder) and when to use the group email instead.
