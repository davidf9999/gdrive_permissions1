...
| [`docs/GLOSSARY.md`](GLOSSARY.md) | Short definitions of common setup and usage terms. | New administrators & editors | Expand when new terms appear in guides or the UI. |
...
| [`docs/AUTO_SYNC_GUIDE.md`](AUTO_SYNC_GUIDE.md) | Explains optional AutoSync triggers. | Advanced Super Admins | Validate instructions alongside `RISK_BASED_AUTO_SYNC.md`. |
| [`docs/RISK_BASED_AUTO_SYNC.md`](RISK_BASED_AUTO_SYNC.md) | Details the risk-based AutoSync safeguards. | Advanced Super Admins | Ensure screenshots and copy match the current script options. |
